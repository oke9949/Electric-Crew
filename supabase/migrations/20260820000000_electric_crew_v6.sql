-- Electric Crew 6.0 - complete Supabase schema
-- Apply with: supabase db push
-- Designed for both fresh projects and the earlier Electric Crew alpha schema.
...
-- Upgrade columns created by the earlier alpha SQL.
...
-- Work logs can only be changed by their owner unless a manager performs the action.
